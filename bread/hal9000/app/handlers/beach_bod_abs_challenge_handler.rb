...
class BeachBodAbsChallengeHandler < ApplicationHandler

  route(/^beach bod time$/i, :exercise_time, command: false, help: { "beach_bod_abs_challenge_time" => "returns a random ab exercise and a time-based intensity" })
