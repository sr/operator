...
func _GcloudService_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(StopRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(GcloudServiceServer).Stop(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
