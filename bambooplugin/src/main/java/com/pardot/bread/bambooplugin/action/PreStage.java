...
public class PreStage implements PreStageAction {
    private static Logger log = Logger.getLogger(PreStage.class);
    ...
    @Override
    public void execute(@NotNull final StageExecution stageExecution) throws InterruptedException, Exception {
        setPendingGithubStatus(stageExecution);
    }

    private void setPendingGithubStatus(final StageExecution stageExecution) {
