...
// Client API for PrivateService service
...
func (c *privateServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*operator.Response, error) {
	out := new(operator.Response)
	err := grpc.Invoke(ctx, "/testing.PrivateService/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for PrivateService service
...
func _PrivateService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/testing.PrivateService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateServiceServer).Ping(ctx, req.(*PingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _PrivateService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "testing.PrivateService",
...
var fileDescriptor0 = []byte{
	...
	0xaa, 0x90, 0x09, 0x17, 0x07, 0x48, 0x49, 0x40, 0x3e, 0x29, 0xba, 0x8c, 0x9c, 0xb8, 0xf8, 0x02,
	0x8a, 0x32, 0xcb, 0x12, 0x4b, 0x52, 0x83, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x49, 0xb7, 0xd9,
	0x49, 0x30, 0x8a, 0x1f, 0x26, 0x08, 0xd5, 0x92, 0xc4, 0x06, 0x0e, 0x0b, 0x63, 0x40, 0x00, 0x00,
	0x00, 0xff, 0xff, 0x10, 0x58, 0x5f, 0x37, 0x3d, 0x01, 0x00, 0x00,
}
