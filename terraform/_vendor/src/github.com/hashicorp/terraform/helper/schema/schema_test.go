...

		{
			...
			Diff: &terraform.InstanceDiff{
				Attributes: map[string]*terraform.ResourceAttrDiff{
					...
					"alarm_configuration.0.alarms.2356372769": {
						Old:        "foo",
						New:        "",
						NewRemoved: true,
					},
					"alarm_configuration.0.enabled": {
						Old:        "true",
						New:        "false",
						NewRemoved: true,
					},
					"alarm_configuration.0.ignore_poll_alarm_failure": {
						Old:        "",
						New:        "",
						NewRemoved: true,
					},
...

		{
			...
			Diff: &terraform.InstanceDiff{
				Attributes: map[string]*terraform.ResourceAttrDiff{
					...
					"type_set.12345.required": {
						Old:        "Required",
						New:        "",
						NewRemoved: true,
					},
					"type_set.12345.value": {
						Old:        "0",
						New:        "0",
						NewRemoved: true,
					},
					"type_set.12345.required_value": {
						Old:        "5",
						New:        "0",
						NewRemoved: true,
					},
					"type_set.12345.computed_value": {
						NewRemoved: true,
					},
				},
			},
