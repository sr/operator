...
import flag "flag"
import github_com_sr_operator_src_gcloud "github.com/sr/operator/src/gcloud"
...
type serviceCommand struct {
	client github_com_sr_operator_src_gcloud.GCloudServiceClient
}

func newServiceCommand(client github_com_sr_operator_src_gcloud.GCloudServiceClient) *serviceCommand {
	return &serviceCommand{client}
}

func (s *serviceCommand) ListInstances() (*github_com_sr_operator_src_proto.Output, error) {
	...
	response, err := s.client.ListInstances(
		...
		&github_com_sr_operator_src_gcloud.ListInstancesRequest{
...
func main() {
	...
	client := github_com_sr_operator_src_gcloud.NewGCloudServiceClient(conn)
