...
import flag "flag"
import github_com_sr_operator_src_papertrail "github.com/sr/operator/src/papertrail"
...
type serviceCommand struct {
	client github_com_sr_operator_src_papertrail.PapertrailServiceClient
}

func newServiceCommand(client github_com_sr_operator_src_papertrail.PapertrailServiceClient) *serviceCommand {
...
func (s *serviceCommand) Search() (*github_com_sr_operator_src_proto.Output, error) {
	...
	response, err := s.client.Search(
		...
		&github_com_sr_operator_src_papertrail.SearchRequest{
			Query: *query,
		},
	)
	if err != nil {
...
func main() {
	...
	client := github_com_sr_operator_src_papertrail.NewPapertrailServiceClient(conn)
