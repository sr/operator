...
resource "aws_security_group" "artifactory_instance_secgroup" {
  ...
  # Notes on why "aws_vpc.internal_tools_integration.cidr_block" above and below
...
resource "aws_vpc" "internal_tools_integration" {
...
resource "aws_subnet" "internal_tools_integration_us_east_1a" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
...
resource "aws_subnet" "internal_tools_integration_us_east_1c" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
...
resource "aws_subnet" "internal_tools_integration_us_east_1d" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
...
resource "aws_subnet" "internal_tools_integration_us_east_1e" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
...
resource "aws_subnet" "internal_tools_integration_us_east_1a_dmz" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
  availability_zone       = "us-east-1a"
...
resource "aws_subnet" "internal_tools_integration_us_east_1c_dmz" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
  availability_zone       = "us-east-1c"
...
resource "aws_subnet" "internal_tools_integration_us_east_1d_dmz" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
  availability_zone       = "us-east-1d"
...
resource "aws_subnet" "internal_tools_integration_us_east_1e_dmz" {
  vpc_id                  = "${aws_vpc.internal_tools_integration.id}"
  availability_zone       = "us-east-1e"
...
resource "aws_internet_gateway" "internal_tools_integration_internet_gw" {
  vpc_id = "${aws_vpc.internal_tools_integration.id}"
}

resource "aws_eip" "internal_tools_integration_nat_gw" {
  vpc = true
}

resource "aws_nat_gateway" "internal_tools_integration_nat_gw" {
  allocation_id = "${aws_eip.internal_tools_integration_nat_gw.id}"
  subnet_id     = "${aws_subnet.internal_tools_integration_us_east_1a_dmz.id}"
}

resource "aws_route" "internal_tools_integration_route" {
  route_table_id         = "${aws_vpc.internal_tools_integration.main_route_table_id}"
  destination_cidr_block = "0.0.0.0/0"
  nat_gateway_id         = "${aws_nat_gateway.internal_tools_integration_nat_gw.id}"
}

resource "aws_route_table" "internal_tools_integration_route_dmz" {
  vpc_id = "${aws_vpc.internal_tools_integration.id}"

  route {
    cidr_block = "0.0.0.0/0"
    gateway_id = "${aws_internet_gateway.internal_tools_integration_internet_gw.id}"
  }
...
resource "aws_route_table_association" "internal_tools_integration_us_east_1a" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1a.id}"
  route_table_id = "${aws_vpc.internal_tools_integration.main_route_table_id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1c" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1c.id}"
  route_table_id = "${aws_vpc.internal_tools_integration.main_route_table_id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1d" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1d.id}"
  route_table_id = "${aws_vpc.internal_tools_integration.main_route_table_id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1e" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1e.id}"
  route_table_id = "${aws_vpc.internal_tools_integration.main_route_table_id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1a_dmz" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1a_dmz.id}"
  route_table_id = "${aws_route_table.internal_tools_integration_route_dmz.id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1c_dmz" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1c_dmz.id}"
  route_table_id = "${aws_route_table.internal_tools_integration_route_dmz.id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1d_dmz" {
  subnet_id      = "${aws_subnet.internal_tools_integration_us_east_1d_dmz.id}"
  route_table_id = "${aws_route_table.internal_tools_integration_route_dmz.id}"
}

resource "aws_route_table_association" "internal_tools_integration_us_east_1e_dmz" {
...
resource "aws_security_group" "artifactory_mysql_ingress" {
  ...
  ingress {
    ...
    cidr_blocks = [
      "${aws_subnet.internal_tools_integration_us_east_1a.cidr_block}",
      "${aws_subnet.internal_tools_integration_us_east_1a_dmz.cidr_block}",
      "${aws_subnet.internal_tools_integration_us_east_1c.cidr_block}",
      "${aws_subnet.internal_tools_integration_us_east_1c_dmz.cidr_block}",
      "${aws_subnet.internal_tools_integration_us_east_1d.cidr_block}",
      "${aws_subnet.internal_tools_integration_us_east_1d_dmz.cidr_block}",
    ]
  }
